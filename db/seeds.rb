[
    { code: "two_for_one", accumulate: false, quantity: 2 },
    { code: "bulk_purchases", accumulate: true, quantity: 3 }
...
[
    { code: "VOUCHER", name: "Cabify Voucher", price: 5, pricing_rule_id: PricingRule.find_by(code: 'two_for_one') },
    { code: "TSHIRT", name: "Cabify T-Shirt", price: 20, pricing_rule_id:  PricingRule.find_by(code: 'bulk_purchases') },
